...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (operacao) {
                case "1":
                    String nomeCurso = JOptionPane.showInputDialog("Informe o Nome Curso");
                    cursos.add(new Curso(nomeCurso));
                    break;
                case "2":
                    String nomeCursoP = JOptionPane.showInputDialog("Informe o Nome Curso");
                    ...
                    break;
                case "3":
                    String nomeCursoA = JOptionPane.showInputDialog("Informe o Nome Curso");
                    try {
